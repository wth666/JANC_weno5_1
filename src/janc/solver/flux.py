...
def WENO_Y_x(Y):
    ...
    IS1 = 1 / 4 * jnp.power((Yjm2 - 4 * Yjm1 + 3 * Yj), 2) + 13 / 12 * jnp.power((Yjm2 - 2 * Yjm1 + Yj), 2)
    IS2 = 1 / 4 * jnp.power((Yjm1 - Yjp1), 2) + 13 / 12 * jnp.power((Yjm1 - 2 * Yj + Yjp1), 2)
    IS3 = 1 / 4 * jnp.power((3 * Yj - 4 * Yjp1 + Yjp2), 2) + 13 / 12 * jnp.power((Yj - 2 * Yjp1 + Yjp2), 2)
    ...
    fj_halfp1 = 1 / 3 * Yjm2 - 7 / 6 * Yjm1 + 11 / 6 * Yj
    fj_halfp2 = -1 / 6 * Yjm1 + 5 / 6 * Yj + 1 / 3 * Yjp1
    fj_halfp3 = 1 / 3 * Yj + 5 / 6 * Yjp1 - 1 / 6 * Yjp2
